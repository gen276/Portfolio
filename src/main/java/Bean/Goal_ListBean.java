...
public class Goal_ListBean implements Serializable{
    ...
    public Goal_ListBean(String tmpYear, String tmpMonth, String tmpWeek, String tmpDate, String tmpM_Goal, String tmpW_Goal, int tmpStep_Num, String tmpStep_Content, String tmpAchieve) {
    }
