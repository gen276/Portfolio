        ...
        <main>
            <div class = "msg_container">
				...
				<form action="./step_comp" method = "post">						
			            ...
			            <td><input type = "hidden" value = "1" name = "complete">
			            	<input type = "hidden" value = "<jsp:getProperty name = "StudentName" property = "name" />" name = "name">
			            	<button type = "submit" onclick = "return changeline('comp1')">
			            	完了</button></td></tr>
			    </form>
			            
			    <form action="./step_comp" method = "post">
						<tr><th>ステップ2</th><td><%=goal.getStep2() %></td>
						<td><input type = "hidden" value = "2" name = "complete">
							<input type = "hidden" value = "<jsp:getProperty name = "StudentName" property = "name" />" name = "name">
